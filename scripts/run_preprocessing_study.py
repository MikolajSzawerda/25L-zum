...
def main():
    ...
    for prep_name, prep_config in tqdm(
        PREPROCESSING_CONFIGS.items(), desc="Preprocessing Configs"
    ):
        for vec_name, vec_config in tqdm(
            VECTORIZER_CONFIGS.items(), desc="Vectorizer Configs"
        ):
